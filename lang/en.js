...
langStrings["en"].restartButton = "Restart";
...
langStrings["en"].gameAux = "Process type (RT = Real Time | TS = Time Sharing)";
...
langStrings["en"].game12 = "To more information about the events, click the <span class='label label-primary'>Log</span> button to see more clearly all past events.";
...
langStrings["en"].btn_game6 = "Restart the simulation";
langStrings["en"].btn_game7 = "Events log";
...
langStrings["en"].automatic = "Click on this button to make a scheduling in automatic mode";
langStrings["en"].stepByStep = "Click on this button to make a scheduling in step by step mode";
